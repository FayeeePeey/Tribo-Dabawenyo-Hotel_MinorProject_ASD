...
<html>
    <head>
        <link rel="stylesheet" type="text/css" href="css/deluxe_rooms.css">
		 ...
		 <span>
            <form id="form" method="post" action="reserve.php">
                ...
                <div class="signup_con">
					...
					<input type="hidden" name="roomnum" value="3">
                    <span class="lname">
                        <b>Last Name</b>
						<br>
